    ...
    <div class="all-content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                <h4 class="text-left text-uppercase"><b>Number of Farmers</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    <!-- <div class="col-xs-3 mar-bot-15 text-left">
                                        <label class="label bg-green"> <i class="fa fa-level-up" aria-hidden="true"></i></label>
                                    </div> -->
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        <h2 class="text-right no-margin">{{(count($far))}}</h2>
                                    </div>
                                </div>
        ...
        <div class="product-sales-area mg-tb-30">
               ...
               <div style="position:relative;left:500px;">
                    ...
                    @if(count($au)>0)
					<table>
							  <form method="post" action="/gobid" enctype="multipart/form-data">
							  @csrf
							  @foreach($au as $user)	
                              <tr>
                                  <td>Tool Name: </td><td><input type="text" value="{{ $user->toolname }}" disabled class="form-control"></td></tr>
  
                                  <input type="hidden" value="{{ $user->id }}" name="bb"  class="form-control"></td>
  
  <tr><td>Image:</td> <td><img src="{{asset('storage/upload/'.$user->image)}}"></td></tr>
  <tr><td>Start Date:</td><td><input type="date" name="g" class="form-control" value="{{$user->start}}" disabled></td></tr>
  <!-- <tr><td>End Date:</td><td><input type="date" name="m" class="form-control" value="{{$user->end}}" disabled></td></tr> -->
  <tr><td>Price:</td><td><input type="number" min="1" name="p" class="form-control"required value="{{$user->price}}" ></td></tr>
  <!-- <tr><td> Maximum Price:</td><td><input type="number" min="1" name="x" class="form-control"value="{{$user->max}}" disabled></td></tr> -->
  <tr><td>Current Farmer To Get Bid:</td><td><input type="text" min="1" name="f" class="form-control"value="{{$user->email1}}" ></td></tr>
