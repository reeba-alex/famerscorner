...
<?php
$date=date ('Y-m-d') ;
$gg= date('Y-m-d', strtotime($date. ' + 1 days'));
?>
<head>
    <meta charset="utf-8">
	...
	<link rel="stylesheet"
          href="http://127.0.0.1:8000/admin1/dist/css/dyclock.min.css">
...
<body >
    <!-- style="background-image:url(/images/auction1.jpg);"-->
    <!--[if lt IE 8]>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="product-sales-area mg-tb-30">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"style="width:700px;">
               ...
               <div style="position:relative;left:200px;width:1000px;height:800px;background-image:url(/images/dd8.png);">
                   
                    @if(count($a)>0)
                    <div style=""><br><br><br><br><br><br><br><br><br><br><br><br>
					<table>
                   
							  <form method="post" action="/auctionedit" enctype="multipart/form-data">
							  @csrf
							  @foreach($a as $user)	
                              <tr>
                                  <!-- <td><font color="red">Tool Name:</font> </td><td><input type="text" value="{{ $user->toolname }}" disabled class="form-control"></td></tr> -->
  
                                  <input type="hidden" value="{{ $user->id }}" name="bb"  class="form-control"></td>
                                  <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
  <tr><td>&nbsp;</td> <td><img src="{{asset('storage/upload/'.$user->image)}}"><br><font color="red">{{ $user->toolname }}</font></td></tr>
  <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
  <tr><td><font color="red">Start Date:</font></td><td><input type="date" name="g" class="form-control" min="<?php echo $date; ?>"  required></td></tr>
  <!-- <tr><td>End Date:</td><td><input type="date" name="m" class="form-control" min=" max="  required></td></tr> -->
  <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
  <tr><td><font color="red">Starting Price:</font></td><td><input type="number" min="1" name="p" class="form-control"required autocomplete="off" onchange='price();'  value="0" step="0.01"></td></tr>
  <!-- <tr><td> Maximum Price:</td><td><input type="number" min="1" name="x" class="form-control"required autocomplete="off" onchange='price();'  value="0" step="0.01"></td></tr> -->
  <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
                                  ...
                                  function price() 
{
    ...
    return true;
				...
				@else
					...
					<font color="red" style="size:20px;">	There is no auction Tool.</font>
