...
<head>
    ...
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="127.0.0.1:8000/img/favicon.ico">
    <!-- Google Fonts
		============================================ -->
	...
	<link rel="stylesheet" href="http://127.0.0.1:8000/admin1/dist/css/dyclock.min.css">
                    ...
                    <ul class="metismenu" id="menu1">
                        <!-- <li class="active"> -->
                            ...
                            <li><a title="FarmerList" href="/newfarmer"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Approve Farmer</span></a></li>
                               ...
                               <!-- <li><a title=" auction" href="/auction"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro"> Auction</span></a></li> -->
                            </ul>
                        <!-- </li> -->
    ...
    <div class="all-content-wrapper">
        ...
        <p>@if(\Session::has('success'))
                    ...
                    <br><br>
                            ...
                            <div class="product-status-wrap" style="font-weight:bolder;font-color:white;">
                            @if(count($data)>0)
                            <center>
                            <form action="/proceed" method="post">
                            @csrf
							  @foreach($data as $user)	
                          <font color="red">   Auction Get</font><br>
                              <img src="{{asset('storage/upload/'.$user->image)}}"><br>
{{ $user->fname }} {{ $user->lname }}<br>
<input type="hidden" value="{{$user->did}}" name="aa">
{{ $user->housename }}               
{{ $user->panchayath }}{{ $user->pin }} <br>                                 
{{ $user->ph }} 
 	<br>					  
@endforeach
                           ...
                           <div style="background-color:pink;width:800px;">
                       <font color="red">    Auction For:  </font>{{ $user1->toolname}} <br> 
                            <img src="{{asset('storage/upload/'.$user1->image)}}"><br>
                            
{{ $user1->amount }}    Rupeese<br>   
<input type="hidden" value="{{$user1->id}}" name="bb">Last Date Of Payment
...
@else
<font color="red"><b>NO BIDDING PROCEED AUCTION RETURN TO ADMIN</b></font>
@endif 		  
                          ...
                          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            ...
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30" style="background-color:lightgreen;height:200px;">
                                <h4 class="text-left text-uppercase"><b> <a href="/running">RUNNING AUCTION DETAILS</a></b></h4>
                                <img src="/images/auc.jpg" style="position:relative;float:left;  width:200px;height:100px;border-radius:100px;"/>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    <!-- <div class="text-left col-xs-3 mar-bot-15">
                                        <label class="label bg-purple">80% <i class="fa fa-level-up" aria-hidden="true"></i></label>
                                    </div> -->
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="width:100px;">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                ...
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    ...
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                    <!-- <img src="/images/auc.jpg" style="position:relative;float:left;left:300;  width:200px;height:100px;border-radius:100px;"/> -->
                                    </div>
                                </div>
                                <!-- <div class="progress progress-mini">
                                    <div style="width: 60%;" class="progress-bar bg-purple"></div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30"style="background-color:lightgreen;height:200px;">
                                <h4 class="text-left text-uppercase"><b> <a href="/managetool">Manage Auction Tools</a></b></h4>
                                <img src="/images/auc.jpg" style="position:relative;float:left;left:300;  width:200px;height:100px;border-radius:100px;"/>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                <!-- <div class="progress progress-mini">
                                    <div style="width: 60%;" class="progress-bar bg-purple"></div>
	...
	<!-- <p id="date" style="border:double;width:170px;height:30px;background-color:lightgreen;position:relative;left:850px;"><br></p></center>  -->
	<script>
...
<script src="http://127.0.0.1:8000/admin1/dist/js/dyclock.min.js"></script>
<script>
