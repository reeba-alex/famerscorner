        ...
        <div class="section-admin container-fluid" >
            <div class="row admin text-center">
                <div class="col-md-12"style="background-color:red;">
					...
					@endif</p>
                            @if(count($au)>0)
                          <center>  NEW TOOLS FOR AUCTION, FIX AUCTION <font color="red">DATE</font> AND STARTING<font color="red"> PRICE</font> </center>
                          <br>
                            <table border="5px">
                              ...
                              <tr>
                               ...
                               <td><font color="blue">Farmer Email</font></td>
                               <td><font color="blue">Tool Name</font></td>
...
<td>{{ $user->toolname }}</td>
<td><img src="{{asset('storage/upload/'.$user->image)}}"></td>
                                  ...
                                  {{ $user->des }}
                                      ...
                                      <a href="{{route('aude.edit',$user->id)}}">
									  <img src="/images/auc.jpg" style="position:relative;float:left;  width:100px;height:50px;border-radius:100px;"/>
									  </a>
                                      </td>  
                          ...
                          @else
                          NO NEW TOOL FOR AUCTION
                          @endif 
                          <div>
                          <br><br><br><br>
                          <center>
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="height:200px;width:300px;background-image:url(/images/auction2.jpg);>
