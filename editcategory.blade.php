...
<head>
    ...
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="http://127.0.0.1:8000/img/favicon.ico">
    <!-- Google Fonts
		============================================ -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-bottom:1px;">
                            ...
                            <h4><b> <a href="/category">Number of Allowed Category</a></b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                            <h4 ><b> <a href="croin">Number of Crop Registered</a></b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    <!-- <div class="text-left col-xs-3 mar-bot-15">
                ...
                <div class="row">
                   <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        <div class="product-sales-chart">
                            ...
                            </ul> --><p><font color="red"style="font-size:30px;">****Edit Category  Details****</font></p>
                            <div class="product-status-wrap" style="font-weight:bolder;font-color:white;background-color:lightgreen;">
                     			
					
                            <form action="{{route('category5.update',$category->id)}}" method="post" enctype="multipart/form-data">
                       @method('PATCH')
                       <table>
                       <input type="hidden" name="_token" value="{{ csrf_token() }}">
                       <tr>    <td><label>CATEGORY NAME:<label></td><td></td><td><input type="text" name="cat" id="firstname" value="{{$category->name}}" class="form-control" style="width:200px;" autocomplete="off" required onchange='Validlast1();'><br><br>
</td></tr>
<script>		
function Validlast1() 
{
...
<tr>    <td><label>CHOOSE IMAGE:<label></td><td></td><td><a data-toggle="modal" data-target="#modal-delete-{{ $category->id }}"><img src="{{asset('storage/upload/'.$category->image)}}" class="form-control" style="width:200px;height:100px;" alt="image"  width="82" height="86"/></a>
</td></tr>

<br><br>
<tr><td></td><td></td><td><input type="submit" value="SUBMIT" class="form-control" style="width:200px;">
</td></tr></table>
...
<!--                     
    ...
    <div class="modal fade" id="modal-delete-{{ $category->id }}" tabIndex="-1">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><font color="red">Please Choose Another Image</font></h4>
          </div>
          <div class="modal-body" bgcolor="red">
            <p class="lead">
          <!--  <i class="fa fa-question-circle fa-lg"></i> -->
              <form method="post" action="/category6" enctype="multipart/form-data">
            ...
            <input type="file" name="img1" accept="image/*" style="width:200px;" required>
            <br><br>
...
<script>
    window.onload = function () {
        dyscrollup.init({
            ...
            scrolldelay: 300,
            position: 'right',
            image: "http://127.0.0.1:8000/images/32.png",
            shape: 'other',
            width: 30,
            height: 30
        });
        ...
        var clockObjExample = new dyClock("#dyclock-analog-example", {
            clock: "analog",
            image: "http://127.0.0.1:8000/images/c01.png",
            radius: 60,
            showdigital: true,
            format: "hh:mm:ss A"
        });
        ...
        var clockObj8 = new dyClock("#dyclock-analog-8", {
            clock: "analog",
            image: "http://127.0.0.1:8000/images/c02.png",
            showdigital: true,
            format: "hh:mm:ss A",
            digitalStyle: {
                fontColor: "black",
        ...
        var clockObj9 = new dyClock(".dyclock-analog-9", {
            ...
            image: "http://127.0.0.1:8000/images/c03.png",
            showdigital: true,
            radius: 120,
            analogStyle: {
                backgroundColor: "#eee",
