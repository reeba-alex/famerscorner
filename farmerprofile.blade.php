...
@csrf
  ...
  @foreach($data as $user)
  <tr><td> <img src="{{asset('storage/upload/'.$user->image)}}"data-toggle="modal" data-target="#exampleModal5" alt="John" style="width:100px;height:100px;border-radius:100px;"></td></tr>
 
  <tr><td>{{ $user->fname }} {{ $user->lname }}</td></tr>
  <tr><td>&nbsp;</td></tr>
  <tr><td>{{ $user->email }}</td></tr>
 <tr><td> {{ $user->ph }}</td></tr>
 <tr><td> {{ $user->housename }}</td></tr>
 <tr><td> {{ $user->country }}</td></tr>
 <tr><td>{{ $user->state }}</td></tr>
 <tr><td>{{ $user->district }}</td></tr>
 <tr><td> {{ $user->panchayath }}</td></tr>
 <tr><td>{{ $user->pin }}</td></tr>
 @endforeach
 <!--<tr> <div style="margin: 24px 0;">
    <a href="#"><i class="fa fa-dribbble"></i></a> 
    <a href="#"><i class="fa fa-twitter"></i></a>  
    <a href="#"><i class="fa fa-linkedin"></i></a>  
    <a href="#"><i class="fa fa-facebook"></i></a> 
  </div></tr>-->
 <tr><td><font color="white"><input type="submit" value="Edit" style="width:100%;height:20%;background-color:black;"></font></td><tr></table></form>
</div>
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Choose Your Profile Photo</font></h5>
               ...
               <div class="modal-body">
                  ...
                  <form action="/prophoto" method="post" enctype="multipart/form-data" >
                     @csrf
                     
                                          <div class="row">
                                             <div class="col-md-6">
                                             <label><font color="red"></label>
                                                 <input type="hidden" name="id" value="{{$user->did}}" required> 
                                             </div>
                                             <div class="col-md-6">
                                          ...
                                          <input type="file" name="photo" id="l">
                                          <br>
