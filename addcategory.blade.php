                ...
                <div class="row">
                   <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        <div class="product-sales-chart">
                           ...
                           <center> <p><font color="red"style="font-size:30px;">****Add Crop Category****</font></p></center>
...
<td><img src="{{asset('storage/upload/'.$user->image)}}"></td>
                                  ...
                                  <td>               
                                      ...
                                      <a href="{{route('category1.edit',$user->id)}}">
									  EDIT
									  </a>
                                      <td>               
							  
                              <a href="category2/{{$user->id}}">
                              DELETE
                              </a>
				...
				@else
					...
					<font color="red" style="size:20px;">	There is no category.</font>
