...
<div>
	  <!-- <div style="background-image:url('../images/dd1.png');position:relative;float:left;width:1600px;height:1500px;"> -->
    <p>@if(\Session::has('success'))
					...
					@endif</p>
        <!-- width:1000px;height:700px;border-radius:10px; -->
	  
	  <img src="/images/dd1.png" style="position:relative;float:left;left:300;  width:800px;height:800px;border-radius:100px;"/>
	  <br><br>
	   <div style="float:left;left:20px;position:relative;border:double;border-radius:10px;height:500px;background-color:lightgreen;" > 
	  
    <h3>Register Your Used Tools Into Here,  For Auction..<span>&#128071;</span> </h3>
                    <!-- <p style="font-color:green;font-size:20px;"><font color="blue">Register Here Earn From Home</font> </p> -->
               
<!-- <hr style="color:blue;"> --><br><br><br>
<center>
                <form action="/auctionstore" method="post" enctype="multipart/form-data" >
@csrf
<table>
...
<!-- <tr><td><label><font size="3px">Select Category:</font></label></td>
                     <td>  <select id="state" class="form-control" style="border-color:red;border-radius:10px;"name="cat" required >
                            <option value="" selected disabled>Select</option>
                               ...
                               <tr><td>&nbsp;</td><td>&nbsp;</td></tr> -->
<tr><td><label><font size="3px">Tool Name:</font></label></td>
...
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
 ...
 <tr><td>  <label><font size="3px">Image:</font></label></td>
                                 ...
                                 <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
 <tr><td><label><font size="3px">Description About Your Tool:</font></label></td>
