...
<body  style="background-color:lightgreen;">
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                                          ...
                                                          <!-- <li><a title="Add Product" href="/addproduct"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Add Product</span></a></li> -->
                            ...
                            <!--    <li><a title="FarmerList" href="/newfarmer"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Farmer List</span></a></li>
    ...
    <div class="all-content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="header-top-wraper">
                             ...
                             <!--message                   <li class="nav-item dropdown">
		...
		<h2 style="text-align:center"><font color="red"><b><i>User Profile Card<b><i></font></h2>
        <center>
		 <div class="single-product-tab-area mg-tb-15" style="background-color:green;width:500px;">
...
<td><input type="hidden" value="{{ $user->did }}" name="bb" style="width:100%;" ></td></tr>

<!-- <td>Profile Pic:</td><td><input type="file" value="{{$user->image}}" name="pic" class="form-control" id="fileChooser" placeholder="profile pic" onchange='ValidateFileUpload();' required></td></tr> -->
...
//The file upload is NOT an image
  ...
  <tr><td>First Name:</td><td><input type="text" value="{{ $user->fname }}"name="fn"  class="form-control" id="l" placeholder="Last Name"autocomplete="off"required onchange='Validlast();'></td></tr>
  <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
...
function Validlast() 
{
  ...
  <tr></tr>  <tr></tr>
   <tr><td>Last Name:</td><td><input type="text" value="{{ $user->lname }}"name="ln" class="form-control" id="firstname" placeholder="First Name" autocomplete="off" required onchange='Validlast1();'  ></td></tr>
   <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
   <script>		
function Validlast1() 
{
   ...
   <tr><td>Emil Id:</td><td><input type="text" value="{{ $user->email }}"name="e" class="form-control"  disabled></td></tr>
   <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
   <tr><td>Phone Number:</td><td><input type="text" value="{{ $user->ph }}"name="p" class="form-control"   ></td></tr>
   <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
    <tr><td>House Name:</td><td><input type="text" value="{{ $user->housename }}" name="h" class="form-control"  ></td></tr>
    <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
   <tr><td>Country:</td><td><input type="text" value="{{ $user->country }}"name="c"class="form-control" disabled ></td></tr>
   <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
    <tr><td>State:</td><td><input type="text" value="{{ $user->state }}"name="s"class="form-control" disabled ></td></tr>
    <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
	 <tr><td>District:</td><td><input type="text" value="{{ $user->district }}"name="d" class="form-control"disabled ></td></tr>
     <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
	  <tr><td>Panchayath:</td><td><input type="text" value="{{ $user->panchayath }}"name="pa"class="form-control" disabled ></td></tr>
      <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
	   <tr><td>PIN:</td><td><input type="text" value="{{ $user->pin }}"name="pi"class="form-control" disabled ></td></tr>@endforeach</table>

 <br><br>
 
 <center><font color="white"><input type="submit" value="Edit" style="width:10%;height:20%;background-color:black;" class="form-control" ></font></center></form>
  ...
  <!--      <div class="footer-copyright-area">
    ...
    <!-- calendar JS
		============================================ -->
    <script src="admin1/js/calendar/moment.min.js"></script>
    <script src="admin1/js/calendar/fullcalendar.min.js"></script>
    <script src="admin1/js/calendar/fullcalendar-active.js"></script>
    <!-- plugins JS
		============================================ -->
