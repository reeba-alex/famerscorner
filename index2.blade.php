                  ...
                  <ul style="position:relative;left:700px;" >
                   <!--  <li>
					...
					<!-- <li class="toyscart toyscart2 cart cart box_1" style="position:relative;left:500px;border-radius:10px;">
					  ...
					  <li >
                        <a href="" class="nav-link"style="font-weight:bolder;"data-toggle="modal" data-target="#exampleModal"><font color="white">Login</font></a>
                     </li>
                  </ul>
               </div>
            </div><br>
            <div class="container-fluid" >
               <div class="hedder-up row">
                  <div class="col-lg-3 col-md-3 logo-head">
                     <h1><a class="navbar-brand" href="/">AgroMart</a></h1>
                  </div>
                  <div class="info-contact-agile">
                  <ul style="background-color:white;width:500px;border-radius:8px;position:relative;left:200px;">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="/"><font color="red">Home</font> <span class="sr-only">(current)</span></a>
                     </li>
                     <li class="nav-item">
...
@foreach($data as $user1)
    ...
    <img   class="pro-image-front" src="{{asset('storage/upload/'.$user1->image)}}" style="height:250px;"" >
									...
									<div class="item-info-product ">
										<h4><a href="">{{$user1->cropvariety}}</a></h4>
										<div class="info-product-price">
											<span class="item_price">₹{{$user1->price}}</span>
                                 <div  style="background-color:black;height:30px;width:150px;border-radius:10px;">
                     <a href="{{route('buy3.edit',$user1->id)}}" ><font  style="font-weight:bolder;"> Add To Cart</font></a>
                    </div>
...
<script>
      ...
      <!--//subscribe-->
      <!-- footer -->
      <!-- <footer class="py-lg-4 py-md-3 py-sm-3 py-3 text-center" id="content">
